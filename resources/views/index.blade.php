                ...
                <div class="col-12">
                    <div class="owl-carousel service-carousel">
                        <div class=""> 
                         ...
                         <a href="{{route('formulaire')}}" class="btn-reserve btn-secondary commander-traiteur fs-1 px-3">Résèrvez nos services</a>
                      </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="text-center">
                            ...
                            <h4 class="font-weight-light mb-4">"Je tenais à vous remercier, les gâteaux était magnifiques et délicieux.
                                Une véritable surprise, ma mère était très contente et émue.
                                Encore merci, je vous re-contacterais pour un futur événement."</h4>
                        ...
                        <div class="text-center">
                            ...
                            <h4 class="font-weight-light mb-4">Je recommande vivement cake design by annie Kone.
                                 A plusieurs reprise nous somme passé par elle pour les anniversaires des enfants jamais déçu gâteau aussi beau que bon.
                        ...
                        <div class="text-center">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <h4 class="font-weight-light mb-4">"Un très grand merci pour votre gâteau qui était magnifique et qui a fait un sacré effet pour 
                                l'anniversaire de Théa!!Vraiment un grand Bravo...très beau et très bon...la framboise c'était parfait!!A bientôt!"
                                "Un très grand merci pour votre gâteau qui était magnifique et qui a fait un sacré effet pour l'anniversaire de Théa!!Vraiment 
                                un grand Bravo...très beau et très bon...la framboise c'était parfait!!A bientôt!"</h4>
